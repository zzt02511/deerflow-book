...
- [第 5 章　Lead Agent：大脑的核心循环](chapters/05-lead-agent.md)
- [第 6 章　11 层中间件管道：Agent 的神经系统](chapters/06-middleware-pipeline.md)
- [第 7 章　Context Engineering：上下文工程](chapters/07-context-engineering.md)

## 第三部分：Sub-Agent 系统

- [第 8 章　Sub-Agent 架构总览](chapters/08-subagent-overview.md)
- [第 9 章　SubagentExecutor：执行引擎](chapters/09-subagent-executor.md)
- [第 10 章　并发调度与 Orchestration 策略](chapters/10-orchestration.md)
...
- [第 14 章　Local Sandbox 与 aio-sandbox 深度解析](chapters/14-sandbox-implementations.md)

## 第六部分：工具生态与 MCP

- [第 15 章　内置工具与社区工具](chapters/15-builtin-tools.md)
- [第 16 章　MCP 扩展：无限工具](chapters/16-mcp-extensions.md)
